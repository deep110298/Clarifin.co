    ...
    <div>
      ...
      <div className="relative">
        ...
        <input
          ...
          className={cn(
            "w-full border border-gray-200 rounded-xl py-2.5 text-sm text-[#0D1B2A] bg-white focus:outline-none focus:ring-2 focus:ring-[#1D9E75]/30 focus:border-[#1D9E75]",
  ...
  return (
    <AppLayout>
      <div className="max-w-2xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-[#0D1B2A]">Set up your financial profile</h1>
        ...
        <div className="flex items-center gap-2 mb-8">
          {STEPS.map((label, i) => (
            <div key={label} className="flex items-center gap-2 flex-1">
              ...
              <span className={cn("text-sm font-medium", i === step ? "text-[#0D1B2A]" : "text-gray-400")}>{label}</span>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
          ...
          {step === 0 && (
            <div className="space-y-4">
              <h2 className="font-semibold text-[#0D1B2A] mb-4">Income & Employment</h2>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm text-[#0D1B2A] bg-white focus:outline-none focus:ring-2 focus:ring-[#1D9E75]/30 focus:border-[#1D9E75]"
                >
          ...
          {step === 1 && (
            <div className="space-y-4">
              <h2 className="font-semibold text-[#0D1B2A] mb-4">Monthly Expenses</h2>
              <div className="grid grid-cols-2 gap-4">
          ...
          {step === 2 && (
            <div className="space-y-6">
              <div>
                <h2 className="font-semibold text-[#0D1B2A] mb-4">Savings & Investments</h2>
                <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <h2 className="font-semibold text-[#0D1B2A] mb-4">Debt</h2>
                <div className="grid grid-cols-2 gap-4">
        ...
        <div className="flex justify-between mt-6">
          ...
          {step < STEPS.length - 1 ? (
            <button
              onClick={() => setStep(s => s + 1)}
              className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#1D9E75] hover:bg-[#178f68] text-white text-sm font-medium transition-colors"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-2.5 rounded-xl bg-[#1D9E75] hover:bg-[#178f68] text-white text-sm font-semibold transition-colors disabled:opacity-60"
            >
